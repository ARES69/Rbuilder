...
if not errorlevel 1 (
  winget uninstall --id ru.rbuilder.desktop --silent --accept-source-agreements >nul 2>nul
  winget uninstall --name RBuilder --silent --accept-source-agreements >nul 2>nul
)
